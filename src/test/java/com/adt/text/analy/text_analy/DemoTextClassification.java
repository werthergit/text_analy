...
public class DemoTextClassification
{
     ...
     * 模型保存路径
     */
    public static final String MODEL_PATH = "data/test/classification-model4.ser";
...
//        predict(classifier, "通用及其部分竞争对手目前正在考虑解决库存问题");
        predict(classifier, "李桥镇民办大学，拥有钢铁冶金专业");
//        predict(classifier, "大众高尔夫");
        predict(classifier, "高尔夫球员");
        predict(classifier,"我喜欢煎猪扒,香喷喷的腐竹焖五花肉出锅啦。快点把秋膘贴起来");
        predict(classifier,"侵权行为的性质及原告支付的合理费用，本院认为");
//        predict(classifier, "我爱足球");
        predict(classifier, "黑色金属及其制品 钢轨");
        predict(classifier, "石墨粉 电池工业的电极");
    }
